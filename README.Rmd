...
- `plot_t_test()` Non-interactive function that takes values necessary to do a t-test and visualizes the null and alternative t-statistic distributions. It shows rejection zone and power as areas under the curves. 
